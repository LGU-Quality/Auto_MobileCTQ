...
options.load_capabilities({
	...
	"appium:appPackage": "lgt.call",
	"appium:appActivity": "lgt.call.Main",
	"appium:noReset": True,
...
# uplus.membership/com.uplus.membership.smart.ui.main.MainActivity
...
capabilities = dict(
    ...
    automationName='uiautomator2',
    deviceName='R3CX200EY4K',
    appPackage='uplus.membership',
    appActivity='com.uplus.membership.smart.ui.main.MainActivity',
    noReset=True,
    fullReset=False,
    newCommandTimeout=3600,
)
...
#     automationName='uiautomator2',
#     deviceName='R3CX200EY4K',
#     appPackage='com.nhn.android.nmap',
#     appActivity='com.naver.map.LaunchActivity',
#     noReset=True,
#     fullReset=False,
#     newCommandTimeout=3600,
